...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$is_error) {
        $query = "INSERT INTO `event` (name, description, starts_at, ends_at) VALUES ('$event_name', '$event_description', '$event_starts_at', '$event_ends_at')";
        ...
        <div class="dashboard-container">
            ...
            <div class="dashboard-content-container">
                <div class="dashboard-content admin-dashboard-events">
                    ...
                    <form class="register-form" method="POST" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <button class="btn-primary form-submit-btn" type="submit">Add Event</button>
